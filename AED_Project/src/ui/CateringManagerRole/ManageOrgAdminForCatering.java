...
public class ManageOrgAdminForCatering extends javax.swing.JPanel {
    ...
    public ManageOrgAdminForCatering(Admin Admin, Runnable callOnCreateMethod, String user, String type, ServiceLocation location) {
        initComponents();
        this.Admin = Admin;
...
//    }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(71, 208, 845, 171);
        ...
        add(backBtn);
        backBtn.setBounds(44, 26, 119, 37);

        jLabel1.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel1.setText("LOCATION");
        add(jLabel1);
        jLabel1.setBounds(71, 443, 103, 22);

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel2.setText("ORGANIZATION TYPE");
        add(jLabel2);
        jLabel2.setBounds(71, 503, 197, 22);

        jLabel3.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel3.setText("ORGANIZATION NAME");
        add(jLabel3);
        jLabel3.setBounds(71, 567, 218, 22);

        orgName.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(orgName);
        orgName.setBounds(307, 568, 197, 23);

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel4.setText("NAME");
        add(jLabel4);
        jLabel4.setBounds(590, 443, 60, 22);

        nameField.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(nameField);
        nameField.setBounds(734, 444, 182, 23);

        jLabel5.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel5.setText("USERNAME");
        add(jLabel5);
        jLabel5.setBounds(590, 513, 100, 22);

        usernameField.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(usernameField);
        usernameField.setBounds(734, 514, 182, 23);

        jLabel6.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel6.setText("PASSWORD");
        add(jLabel6);
        jLabel6.setBounds(590, 576, 101, 22);

        passwordField.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(passwordField);
        passwordField.setBounds(734, 577, 182, 23);
        ...
        add(orgCombo);
        orgCombo.setBounds(308, 504, 197, 23);
        ...
        add(deleteBtn);
        deleteBtn.setBounds(928, 335, 116, 44);
        ...
        add(updateButton);
        updateButton.setBounds(928, 282, 116, 41);
        ...
        add(networkName);
        networkName.setBounds(308, 445, 197, 23);

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/CateringManagerRole/catbk.jpeg"))); // NOI18N
        jLabel8.setText("jLabel8");
        add(jLabel8);
        jLabel8.setBounds(0, 0, 1130, 710);
